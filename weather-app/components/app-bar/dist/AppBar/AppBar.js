...
var AppBar = _react.default.forwardRef(function AppBar(props, ref) {
  ...
  return _react.default.createElement(_Paper.default, _extends({
    ...
    component: "header",
    elevation: 4,
    className: (0, _clsx2.default)(classes.root, classes["position".concat((0, _capitalize.default)(position))], (_clsx = {}, _defineProperty(_clsx, classes["color".concat((0, _capitalize.default)(color))], color !== 'inherit'), _defineProperty(_clsx, 'mui-fixed', position === 'fixed'), _clsx), className),
    ref: ref
  }, other));
});
